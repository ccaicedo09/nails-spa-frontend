...
const CitasEmployeeCard = ({ cita }: Props) => {
  const { schedule, service, employee, location, user } = cita;

  return (
    <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-300 rounded-xl shadow-lg p-6 hover:shadow-2xl transition duration-300"
          >
      <div className="mb-4">
        <h3 className="text-xl font-semibold text-rose-600 mb-1">{service.name}</h3>
...
export default CitasEmployeeCard