...
import { Appointment, AvailabilityResponse, CreateAppointmentServerResponse, UpdateAppointmentServerResponse } from "../types/citas"; // Ajusta la ruta según tu estructura
