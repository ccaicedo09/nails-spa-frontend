                ...
                <div key={emp.employeeId} className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {emp.availableSlots.map(slot => (
                      <button
                        key={slot}
                        className={`px-3 py-1 border rounded ${selectedEmployee === emp.employeeId && selectedSlot === slot ? "bg-blue-500 text-white" : "hover:bg-gray-100"}`}
                        onClick={() => {
      ...
      {step === 5 && (
        <div>
          ...
          <textarea
            ...
            rows={4}
          />
          <button onClick={submitAppointment} className="mt-4 btn">Confirmar cita</button>
